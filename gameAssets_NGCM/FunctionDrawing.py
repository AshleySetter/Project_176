...
def draw_snowman(screen,x,y):
    pygame.draw.ellipse(screen,white,[35+x,0+y,25,25],0)  #line thickness 0 = a filled in shape
    pygame.draw.ellipse(screen,white,[23+x,20+y,50,50],0)
    pygame.draw.ellipse(screen,white,[0+x,65+y,100,100],0)
...
while not done: #while loop continues while true (i.e. while not false)
    ...
    draw_snowman(Screen1,0,0)
    
    #creeperX += 0.5
    #creeperY += 0

    Screen1.blit(test_image, [creeperX,creeperY])
